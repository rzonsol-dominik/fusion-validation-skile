...
| Stala | Wartosc | Opis |
|-------|---------|------|
| PERFORMANCE_MAX_FEE_IN_PERCENTAGE | 5000 | Max 50% (100 = 1%) |
| MANAGEMENT_MAX_FEE_IN_PERCENTAGE | 500 | Max 5% (100 = 1%) |
...
- **Warunek**: Jesli vault ma byc zero-fee - obie fee sa 0
- **Jak sprawdzic**: getPerformanceFeeData i getManagementFeeData
- **Oczekiwany wynik**: feeInPercentage == 0 dla obu
